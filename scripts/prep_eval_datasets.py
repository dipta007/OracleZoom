"""Prep the 7 generalization eval datasets into ONE uniform layout the existing
...
Usage:
  uv run scripts/prep_eval_datasets.py [ds ...] [--n 200]
...
REG = {
    ...
    # place the held-out 4KLSDB images in data/4klsdb/hr_test.
