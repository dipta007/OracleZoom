"""Download the training data from HuggingFace and build what the trainer reads.
  ...
  python scripts/prepare_data.py --tier 1k --out data/train_1k
...
Needs an HF token for this dataset (it is private):
...
def build_eval(split_rows, out, limit=0):
    ...
    The six test sets in the paper (DIV8K, DRealSR, RealSR, Flickr2K, FFHQ, 4KLSDB) are
...
def main():
    ...
    ap.add_argument("--repo", default="XXXX/OPDZoom-4KLSDB-train")
